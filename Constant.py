...
inst_strategy = {'c2101': {'strategy':'StrategyRBreaker', 'volume':3},
                 'rb2101': {'strategy':'StrategyFairyFour'},
                 'UR101': {'strategy':'StrategyDoubleMA', 'fast':7,'slow':30, 'volume':2},
                 }
#上海期货交易所 SHFE 大连商品交易所 DCE 郑州商品交易所 CZCE 中国金融期货交易所(CFFEX) 中国国际能源交易所(INE)
exchange_id = {'rb2101':'SHFE', 'c2101':'DCE', 'UR101':'CZCE'}

#{'c2101', strategy_thread}
inst_thread = {}
